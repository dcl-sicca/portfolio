		...
		$(document).ready(function(){
			$("#backtop").scrollToTop({speed:2500,ease:"easeOutBounce",start:250});
	  });
	  
	  
	  $(document).ready(function() {
			$('#apropos').click(function() {
			  $('html,body').animate({scrollTop: $("#sectionApropos").offset().top},'slow');
			});  
		})
	  
		$(document).ready(function() {
			$('#moncv').click(function() {
			  $('html,body').animate({scrollTop: $("#sectionCV").offset().top},'slow');
			});  
		})
	  
		$(document).ready(function() {
			$('#contactform').click(function() {
			  $('html,body').animate({scrollTop: $("#sectionContact").offset().top},'slow');
			});  
		})