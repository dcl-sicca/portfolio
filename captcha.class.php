<?php
   ...
   class PhpCaptcha {
      ...
      private function DrawOwnerText() {
      ...
      private function DrawCharacters() {
         ...
         for ($i = 0; $i < strlen($this->sCode); $i++) {
            ...
            $aCharDetails = imagettfbbox($iFontSize, $iAngle, $sCurrentFont, $this->sCode[$i]);
            ...
            imagettftext($this->oImage, $iFontSize, $iAngle, $iX, $iY, $iTextColour, $sCurrentFont, $this->sCode[$i]);
            ...
            if ($this->bCharShadow) {
               ...
               imagettftext($this->oImage, $iFontSize, $iOffsetAngle, $iX + $iRandOffsetX, $iY + $iRandOffsetY, $iShadowColour, $sCurrentFont, $this->sCode[$i]);
            }
         }
      }
      
      private function WriteFile($sFilename) {
         if ($sFilename == '') {
      ...
      public function Create($sFilename = '') {
         ...
         imagecolorallocate($this->oImage, 230, 234, 255);
